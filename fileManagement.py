...
def refreshData():
    file_manager.refreshObjects(file_manager.data_type_home_folder, file_manager.data_type_min_file_name)
    file_manager.refreshObjects(file_manager.data_class_home_folder, file_manager.data_class_min_file_name)
    file_manager.refreshObjects(file_manager.flow_graph_home_folder, file_manager.flow_graph_min_file_name)
...
def save_all_folders():
    ...
    file_manager.save_home_folder_to_min_file(file_manager.data_type_home_folder)
    file_manager.save_home_folder_to_min_file(file_manager.data_class_home_folder)
    file_manager.save_home_folder_to_min_file(file_manager.flow_graph_home_folder)
